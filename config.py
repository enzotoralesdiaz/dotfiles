...
keys = [
    ...
    # Comando rápido
    Key([mod], "r", lazy.spawn("bash /home/arch/rofi/files/launchers/type-4/launcher.sh"), desc="Abrir lanzador"),
]
        ...
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                        ...
                        active="#ad4e4e",                # Color para grupos activos
                        this_current_screen_border="#BF3032",  # Amarillo para el grupo activo en la pantalla actual

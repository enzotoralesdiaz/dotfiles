...
keys = [
    ...
    # Comando rápido
    Key([mod], "r", lazy.spawn("bash /home/hp/rofi/files/launchers/type-4/launcher.sh"), desc="Abrir lanzador"),
]
...
layouts = [
    layout.Columns(
        ...
        margin=5,  # Espaciado entre ventanas
        ...
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                        ...
                        active="#faa14d",                # Color para grupos activos
                        this_current_screen_border="#e37005",  # Amarillo para el grupo activo en la pantalla actual
                ...
                widget.TextBox("", fontsize=34, padding=1, foreground="#eb8909", background="#0b0e0f"),
                widget.Clock(format=" %I:%M ", background="#eb8909", font="Fira Code Nerd Font"),

                widget.TextBox("", fontsize=34, padding=1, foreground="#db6e07", background="#eb8909"),
                widget.Clock(format=" %d/%m/%Y  ", background="#db6e07", font="Fira Code Nerd Font"),
                
                
            ],
            34,  # Altura de la barra
            background="#0b0e0f",
            margin=[3, 3, 0, 3],  # Márgenes
            border_width=[2, 2, 2, 2],  # Bordes de la barra
            opacity=0.9,
            border_color="",  # Color de los bordes
            #bordes redondos #border_radius=25,
        ),
    ),
]
